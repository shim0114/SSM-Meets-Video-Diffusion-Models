# Source: universome/fvd-comparison/compare_metrics.py
# This code was copied from universome's fvd-comparison project, specifically the compare_metrics.py file.
# For more details and license information, please refer to the original repository:
# Repository URL: https://github.com/universome/fvd-comparison 
...
import our_fvd
import frechet_video_distance as their_fvd
