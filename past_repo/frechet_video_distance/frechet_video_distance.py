# Source: google-research/frechet_video_distance/frechet_video_distance.py
# This code was copied from google-research's frechet_video_distance project, specifically the frechet_video_distance.py file.
# For more details and license information, please refer to the original repository:
# Repository URL: https://github.com/google-research/google-research/tree/master/frechet_video_distance
...
def create_id3_embedding(videos):
  ...
  # video_batch_size = int(videos.shape[0])                                            ### Changed ###
  # assert video_batch_size in [batch_size, -1, None], "Invalid batch size"            ### Changed ###
