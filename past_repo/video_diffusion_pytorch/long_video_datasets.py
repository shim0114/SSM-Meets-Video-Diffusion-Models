# Source: plai-group/flexible-video-diffusion-modeling/improved_diffusion/video_datasets.py, test_util.py
# This code was copied from plai-group's flexible-video-diffusion-modeling, specifically the improved_diffusion/video_datasets.py, test_util.py,  file.
...
class GQNMazesDataset(BaseDataset):
    ...
    """
    def __init__(self, path, shard, num_shards, T, image_size=64): ### Changed ###
