...
class GaussianDiffusion(nn.Module):
    ...
    def p_mean_variance(self, x, t, clip_denoised: bool, cond = None, cond_scale = 1.):
        ...
        x_recon = self.predict_start_from_noise(x, t=t, noise = self.denoise_fn.module.forward_with_cond_scale(x, t, cond = cond, cond_scale = cond_scale)) ### Changed ### # for ddp
...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        self.ds = MovingMNISTDataset('mnist_test_seq.npy', image_size=image_size)
