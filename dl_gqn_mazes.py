# Source: plai-group/flexible-video-diffusion-modeling/datasets/mazes.py
# This code was copied from plai-group's flexible-video-diffusion-modeling, specifically the datasets/mazes.py file.
