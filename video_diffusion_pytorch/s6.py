# Source: state-spaces/mamba/mamba_ssm/modules/mamba_simple.py

# This code was copied from albertfgu's state-spaces project.
...
class S6(nn.Module):
    def __init__(
        ...
        self.output_glu = output_glu ### Added ###
...
if __name__ == "__main__":
    ...
    model = S6(d_model=1024, d_state=16, d_conv=4, output_glu=True).cuda()
